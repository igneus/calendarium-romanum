...
and it's main task is to combine information from both and produce a fully and correctly
populated {CalendariumRomanum::Day Day} instance,
...
When there are multiple it means that any one of them can be chosen and celebrated
that day.
